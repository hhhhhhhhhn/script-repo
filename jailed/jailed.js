 ...
 *
 *  JailedSite.js    loaded into both applicaiton and plugin sites
 *  frame.html       sandboxed frame (web)
 *  frame.js         sandboxed frame code (web)
 *  pluginWebWorker.js  platform-dependent plugin routines (web / worker)
 *  pluginWebIframe.js  platform-dependent plugin routines (web / iframe)
 *  pluginNode.js    platform-dependent plugin routines (Node.js)
 *  pluginCore.js    common plugin site protocol implementation
 */
